...
import { storageIndex } from "@/data/storage"
...
const RenderTable = async ({
  ...
  const result = await storageIndex(currentPage, size, query)
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h2 className="mb-4 text-3xl font-bold">Storage</h2>

        <Link href="/asset/storage/new" className={buttonVariants()}>
          Add New
        </Link>
      </div>
