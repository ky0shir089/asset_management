...
import { branchIndex } from "@/data/branch"
...
const RenderTable = async ({
  ...
  const result = await branchIndex(currentPage, size, query)
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h2 className="mb-4 text-3xl font-bold">Branch</h2>

        <Link href="/network/branch/new" className={buttonVariants()}>
          Add New
        </Link>
      </div>
