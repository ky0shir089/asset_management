...
import { companyIndex } from "@/data/company"
...
const RenderTable = async ({
  ...
  const result = await companyIndex(currentPage, size, query)
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h2 className="mb-4 text-3xl font-bold">Company</h2>

        <Link href="/network/company/new" className={buttonVariants()}>
          Add New
        </Link>
      </div>
