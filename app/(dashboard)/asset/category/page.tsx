...
import { assetCategoryIndex } from "@/data/asset-category"
...
const RenderTable = async ({
  ...
  const result = await assetCategoryIndex(currentPage, size, query)
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h2 className="mb-4 text-3xl font-bold">Asset Category</h2>

        <Link href="/asset/category/new" className={buttonVariants()}>
          Add New
        </Link>
      </div>
