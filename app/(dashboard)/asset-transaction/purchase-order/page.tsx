...
import { purchaseOrderIndex } from "@/data/purchase-order"
...
const RenderTable = async ({
  ...
  const result = await purchaseOrderIndex(currentPage, size, query)
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h2 className="mb-4 text-3xl font-bold">Purchase Order</h2>

        <Link href="/asset-transaction/purchase-order/new" className={buttonVariants()}>
          Add New
        </Link>
      </div>
      ...
      <Suspense
        ...
        fallback={<DataTableSkeleton columns={12} />}
      >
